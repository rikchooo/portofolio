          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              {[
                ...
                { year: '2021-2023', skills: ['React', 'Node.js', 'MongoDB'], icon: '⚡' },
                { year: '2019-2021', skills: ['JavaScript', 'Express', 'PostgreSQL'], icon: '📈' },
                { year: '2017-2019', skills: ['HTML/CSS', 'Python', 'MySQL'], icon: '🎯' }
              ].map((item, index) => (
